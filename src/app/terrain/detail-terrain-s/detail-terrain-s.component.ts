...
@Component({
  selector: 'app-detail-terrain-s',
  templateUrl: './detail-terrain-s.component.html',
  styleUrls: ['./detail-terrain-s.component.scss']
})
export class DetailTerrainSComponent implements OnInit {
  terrain: Terrain;
  ...
  ngOnInit(): void {
    ...
    this.route.paramMap.pipe(
      ...
      if (result.status === 0){
        ...
        this.detailTerrainService.getImageDetaiTerrain(this.detailTerrains[1].id)
          .subscribe(data => {
